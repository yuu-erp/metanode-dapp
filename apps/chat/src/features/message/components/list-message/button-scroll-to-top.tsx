...
function ButtonScrollToTop({ ...props }: ButtonScrollToTopProps) {
  return (
    <button
      className="size-12 bg-black/40 rounded-full flex items-center justify-center backdrop-blur-2xl fixed right-2 bottom-24 z-10 transition-transform duration-150 active:scale-80"
      style={{
