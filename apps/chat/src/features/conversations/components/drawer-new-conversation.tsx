...
function DrawerNewConversation() {
    ...
    <Drawer.Root shouldScaleBackground>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 outline-none">
          <div className="bg-white/20 backdrop-filter-app rounded-t-[42px] overflow-hidden flex flex-col h-[90vh] p-3">
            <div className="max-w-md mx-auto w-full">
              <div className="w-full relative flex items-center">
                <Drawer.Close asChild className="outline-none">
                  <button className="size-10 bg-white/40 shadow-2xl rounded-full flex items-center justify-center">
                    <X className="size-6 text-white" />
                  </button>
                </Drawer.Close>
                <Drawer.Title className="font-semibold mb-4 text-lg text-white absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                  New Message
                </Drawer.Title>
              </div>
  ...
  "
                ...
                <button
                  type="button"
                  className="size-12 shrink-0 rounded-full bg-white/40 shadow-md flex items-center justify-center"
                  style={{
                    boxShadow: `2px 2px 6px 0px #0000004D inset`
                  }}
